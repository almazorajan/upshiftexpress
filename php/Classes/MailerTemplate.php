...
class MailerTemplate
{
    ...
    private $facebookLink   = 'https://facebook.com/upshiftexpress';
    private $laceworkLink   = 'https://facebook.com/laceworkis';
    private $twitterLink    = 'https://twitter.com/upshiftexpress';
    private $instagramLink  = 'https://instagram.com/upshiftexpress';
    private $upshiftLink    = 'http://upshift.com.ph';

    private $contactNo1 = '412 44 34';
    private $contactNo2 = '+63 917 517 6355';
    private $contactNo3 = '+63 998 984 8692';
    private $contactNo4 = '+63 925 887 3294';
...
// 	private $newCredentialsTemplate = '
// <td valign="top" class="textContent">
//     <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">     
//         <h3 style="padding:0;margin:0">Login Credentials Update</h3> <br />
//     </div>

//     <div style="text-align:justify;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">     
//         <strong>Login Credentails</strong> <br />
 		
//         <p>You have updated your login credentials.</p>
...
// private $BookingDetailsTemplate = '
// <td valign="top" class="textContent">
//     <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">     
//         <h3 style="padding:0;margin:0">Login Credentials Update</h3> <br />
//     </div>
...
<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
                                                                                ...
                                                                                <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                                    <tr>
                                                                                        <td valign="top" bgcolor="#E1E1E1">
                                                                                            <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                                <div>
                                                                                                    &#169;Copyright'.date('Y').' <a href="'.$this->upshiftLink.'" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Upshift Express Inc</span></a>. All&nbsp;rights&nbsp;reserved.
                                                                                                    <br /> Powered by <a target="_blank" href="'.$this->laceworkLink.'" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">Lacework Innovative Solutions</a></div>
                                                                                                <br />
                                                                                                <p style="color:#828282;">Social Networks:</p>
                                                                                                <a target="_blank" href="'.$this->facebookLink.'" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">facebook</a>
                                                                                                <a target="_blank" href="'.$this->twitterLink.'" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">twitter</a>
                                                                                                <a target="_blank" href="'.$this->instagramLink.'" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">instagram</a>
                                                                                                <br />
                                                                                                <br />
                                                                                                <p style="color:#828282;">Contact No:</p>
                                                                                                <a href="" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">'.$$this->contactNo1.'</a>
                                                                                                <a href="" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">'.$$this->contactNo2.'</a>
                                                                                                <a href="" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">'.$$this->contactNo3.'</a>
                                                                                                <a href="" style="text-decoration:none; color:#828282;margin-left:5px;margin-right:5px;">'.$$this->contactNo4.'</a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
	...
	public function GetNewMemberTemplate()
	{

	}

	public function GetNewCredentialsTemplate()
	{
...
<td valign="top" class="textContent">
    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">     
        <h3 style="padding:0;margin:0">Account Recovery</h3> <br />
    </div>
    <div style="text-align:justify;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">     
        <strong>Login Credentails</strong> <br />       
        <table>
	...
	public function GetBookingDetailsTemplate()
	{
